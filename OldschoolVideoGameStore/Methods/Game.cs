namespace OldschoolVideoGameStore.Methods
{
    public class Game : GamesGenre, IMedia
    {
        ...
        public double NumRatingsCount { get; set; } = 0;
        ...
        public Game(string name, int year, double rating, double numRatings, string genre, Customer renter, bool isRentedOut, bool isRRated, string bio)
        {
            Name = name;
            Year = year;
            Rating = rating;
